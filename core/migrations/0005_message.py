# Generated by Django 5.2 on 2025-11-28 10:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'ordering': ['created_at'],
                'indexes': [models.Index(fields=['sender', 'recipient', 'created_at'], name='core_messag_sender__56952d_idx')],
            },
        ),
    ]
